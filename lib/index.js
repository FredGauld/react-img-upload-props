	...
	(0, _createClass3.default)(ImagesUploader, [{
		...
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(files, url, onLoadEnd) {
				var _props2, owner, ownerId, typeId, imageFormData, i, response, multiple, _imagePreviewUrls2, err, _err;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								// get custom props:
								_props2 = this.props, owner = _props2.owner, ownerId = _props2.ownerId, typeId = _props2.typeId;
		...
		value: function handleImageChange(e) {
			...
			var _props3 = this.props,
			    ...
			    url = _props3.url,
			    optimisticPreviews = _props3.optimisticPreviews,
		...
		value: function buildButtonContent() {
			var _props4 = this.props,
			    ...
			    plusElement = _props4.plusElement;
		...
		value: function buildClose() {
			...
			var _props5 = this.props,
			    ...
			    classNamespace = _props5.classNamespace,
			    disabled = _props5.disabled,
			    classNames = _props5.classNames,
			    styles = _props5.styles,
			    color = _props5.color,
			    disabledColor = _props5.disabledColor,
			    borderColor = _props5.borderColor,
			    disabledBorderColor = _props5.disabledBorderColor,
			    deleteElement = _props5.deleteElement;
		...
		value: function render() {
			...
			var _props7 = this.props,
			    ...
			    label = _props7.label,
			    size = _props7.size,
			    classNamespace = _props7.classNamespace,
			    classNames = _props7.classNames,
			    styles = _props7.styles,
			    color = _props7.color,
			    disabledColor = _props7.disabledColor,
			    borderColor = _props7.borderColor,
			    disabledBorderColor = _props7.disabledBorderColor;
...
ImagesUploader.propTypes = {
	...
	ownerId: _react.PropTypes.number,
	typeId: _react.PropTypes.number
};
